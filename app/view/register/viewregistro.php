...
class viewRegistro extends coreView{
...
<?php require_once MVCDIR.'app/view/header.php'?>
    ...
    <?php
    echo'<div class="bold-line h-100 bg-dark"></div>
    <div class="container py-5 h-100">
      <div class="window">
        <div class="overlay"></div>
        <div class="content">
          <div class="welcome row d-flex justify-content-center align-items-center h-100">¡Bienvenido!</div>
          <div class="subtitle row d-flex justify-content-center align-items-center h-100">Tu primera compra será inolvidable para nosotros.</div>
          ...
          <div><button class="ghost-round full-width row d-flex justify-content-center align-items-center h-100" id="registerbtn">Crear Cuenta</button></div>
        </div>
      </div>
    </div>';?>
<?php require_once MVCDIR.'app/view/footer.php'?>
    ...
    <script type="text/javascript" src="<?php echo URL?>app/javascript/register/register.js"></script>
